      ...
      <div className={`layout ${activeSection ? "expanded" : ""}`} style={{paddingTop:'80px'}}>
        ...
        <div className="left-grid">
          ...
          >
            ...
            <p>
              Hello! I’m a Software Engineer with a background in <span class="highlight">Computer Science</span> (GPA: 8.27) 
              and hands-on experience across application development, business intelligence, and data reporting. </p>
              
            <p>I have worked with <span class="highlight">.NET, SQL Server, and Azure </span>to build and support scalable applications, 
               while also developing
               SSIS/SSRS-based reporting solutions to deliver reliable business insights. My experience includes <span class="highlight">
               writing optimized SQL queries, validating data accuracy, supporting ETL workflows, troubleshooting production issues, and 
               collaborating with stakeholders during UAT and testing phases.</span></p>
             
              <p>I enjoy solving problems from both a technical and analytical perspective — whether 
                that means developing features, improving data quality, or optimizing reporting processes. 
                I’m continuously learning and looking for opportunities where I can contribute across development, data, and support functions.</p>
